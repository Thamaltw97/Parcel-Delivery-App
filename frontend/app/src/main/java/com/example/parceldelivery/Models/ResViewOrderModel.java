...
public class ResViewOrderModel {
    ...
    public ResViewOrderModel() {
    }

    public ResViewOrderModel(long orderId, String receiverName, String receiverMobile, String description,
